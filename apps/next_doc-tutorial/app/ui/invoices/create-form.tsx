...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  // server actions create a POST API endpoint behind the scenes
  return (
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue=""
              // This establishes a relationship between the select element and the error message container with id 'customer-error'.
          ...
          {/* This id attribute uniquely identifies the HTML element that holds the error message for the select input. This is necessary for aria-describedby to establish the relationship. */}
